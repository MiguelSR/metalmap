window.onload = function() {
    ...
    const renderBands = function(styleRow) {
        ...
        const bandsQuery = `${API_ROOT}/sql?q=select * from bands_complex where country ilike '${styleRow.country}' and style like '${styleRow.style}' order by formation_year asc limit 10`;
